...
public class GetMoneyPage {

	void createScene(Stage stage1,String email) throws IOException
	{
	    Label lable = new Label("Table Showing data of MONEY TO RECEIVE: ");
	    lable.setLayoutX(260);
	    lable.setLayoutY(20);
	    lable.setFont(Font.font(null, FontWeight.BOLD, 20));
	    
	    //lable Note
        Label lablenote = new Label("*** NOTE: THE TYPE '2' SHOWS THE MONEY RECEIVED **** ");
	    ...
	    lablenote.setTextFill(Color.RED);
	     ...
	     //text
		 Text  textmark= new Text("           -> Enter the corresponding customer number to mark as RECEIVED (eg : 4): ");
		 textmark.setX(350);
		 textmark.setY(100);
		...
		//BUTTON OK
	        ...
	        ok.setOnAction(new EventHandler<ActionEvent>() {
			        public void handle(ActionEvent t) {
			        	...
			        	cust.changeMe(email,no, "2");
			        	try {
							createScene(stage1, email);
						} catch (IOException e) {
      		...
      		deadline.setCellValueFactory(new PropertyValueFactory<>("DEADLINE"));
      		 ...
      		 try
      		 {
    	         ...
    	         ResultSet rs = conn.createStatement().executeQuery(que);
      	         ...
      	         while(rs.next())
      	         {
      	        	 if(rs.getInt(6) == 0 | rs.getInt(6) == 2)
